...
import { searchClientes } from '@/components/actions/clientes';
import {
    Select,
    SelectContent,
    SelectItem,
...
export function PedidosFilters({ filters, onFilterChange, loading }: PedidosFiltersProps) {
    ...
    // --- LÓGICA DE FILTRADO DE CLIENTE ---
    const selectedClienteValue = filters.cliente_id !== undefined
        ? filters.cliente_id.toString()
        : 'all';
    // --- FIN LÓGICA ---
